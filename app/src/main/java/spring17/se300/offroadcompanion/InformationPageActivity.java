    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (screen){
            ...
            case 6: setContentView(R.layout.activity_whinching);
                textElement = (TextView) findViewById(R.id.whinchText);
                is = getResources().openRawResource(R.raw.whinchtext);
                text = readFile(is);
                textElement.setText(text);
                break;
            case 7: setContentView(R.layout.activity_you);
                textElement = (TextView) findViewById(R.id.youText);
                is = getResources().openRawResource(R.raw.youstext);
                text = readFile(is);
                textElement.setText(text);
                break;
            case 8: setContentView(R.layout.activity_pack);
                textElement = (TextView) findViewById(R.id.packText);
                is = getResources().openRawResource(R.raw.packtext);
                text = readFile(is);
                textElement.setText(text);
                break;
            case 9: setContentView(R.layout.activity_tools);
                textElement = (TextView) findViewById(R.id.toolsText);
                is = getResources().openRawResource(R.raw.toolstext);
                text = readFile(is);
                textElement.setText(text);
                break;
            case 10: setContentView(R.layout.activity_fix);
                textElement = (TextView) findViewById(R.id.fixText);
                is = getResources().openRawResource(R.raw.bmrtext);
                text = readFile(is);
                textElement.setText(text);
                break;
            case 11: setContentView(R.layout.activity_tips);
                textElement = (TextView) findViewById(R.id.tipsText);
                is = getResources().openRawResource(R.raw.tipstext);
                text = readFile(is);
                textElement.setText(text);
                break;
